...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 14 15:55:55 2023
...
class EWRLSChangePoint(EWRLSRidge):
    def __init__(self, num_features: float, span: float = 1000, regularization: float = 0.0,
        ...
        super().__init__(num_features=num_features, span=span, regularization=regularization,
                         history=history)
        self.RESTART_INT = 2
...
def main():
    ...
    model = EWRLSRidge(num_features=2, span=90, regularization=30, history=True)
